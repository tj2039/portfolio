...
<section class = "faci">
	...
	<div class="swim">
		...
		<img src="../images/swimmingpool.png" 
			...
			onclick="window.open('swimm','asdfo8or','scrollbars=yes, width=900,height=700,top=10,left=20');"> 
		<p>
	...
	<div>		
		...
		<img src = "../images/tera.png" style=" position: absolute;
			cursor:pointer" 
			onclick="window.open('tera','asdfo8or','scrollbars=yes, width=900,height=300,top=10,left=20');">	
		<img src = "../images/cabanaa.png" style="margin-left: 560px;cursor:pointer" 
			onclick="window.open('cabana','asdfo8or','scrollbars=yes, width=900,height=600,top=10,left=20');">
		<br>
	...
	<div>
		...
		<img src = "../images/saun.png" style=" position: absolute;
			cursor:pointer" 
			onclick="window.open('sauna','asdfo8or','scrollbars=yes, width=900,height=300,top=10,left=20');">
			
		<img src = "../images/gym.png" style="margin-left: 560px;  cursor:pointer" 
			onclick="window.open('gym','asdfo8or','scrollbars=yes, width=900,height=400,top=10,left=20');">
		<br>
	...
	<div class="swim">
		...
		<img src="../images/loun.png" style="cursor:pointer" 
			onclick="window.open('lounge','asdfo8or','scrollbars=yes, width=900,height=400,top=10,left=20');">
