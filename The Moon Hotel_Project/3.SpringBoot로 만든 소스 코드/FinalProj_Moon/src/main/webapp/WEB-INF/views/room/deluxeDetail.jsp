		...
		<div class="carousel-item active ">
			...
			<div class="rooms">
				...
				<div class = "explain" style="font-size: 20px">
					<p style="font-size: 30px" >이국적인 느낌의 심플한 디자인으로 꾸며진 디럭스 룸</p>
					<p style="font-weight: bold;color: black">심플한 디자인으로 돋보이는 기본 객실로 호텔 본관 2~10층에 위치하고 있습니다.</p>
					<br>
					<문의전화>
					<span style="color: black"> 02-3333-6666</span>
					<br><br>
					<p>파스텔 톤 인테리어의 객실에 휴식을 취할 수 있는 테이블과 체어 </p>
					<p>또는 소파로 구성되어 있는 더문호텔의 디럭스 룸입니다.</p>
