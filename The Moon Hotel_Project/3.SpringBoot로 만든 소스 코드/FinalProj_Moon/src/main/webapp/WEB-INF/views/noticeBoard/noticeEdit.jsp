...
<div id="div1" class="container text-left">
	<form id="frm" method="post" enctype="multipart/form-data" action="/noticeBoard/noticeEdit">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<input type="text" name="title" class="form-control" id="title1" value="${vo.n_title}">
				
			</div>
			<div class="form-group">
				<label for="exampleTextarea" class="form-label mt-4"></label>
				<textarea id="content" name="content"class="form-control" rows="6">${vo.n_content}</textarea>
			</div>
			<div class="form-group">
