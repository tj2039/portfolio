		...
		<div class="carousel-item active ">
			...
			<div class="rooms">
				...
				<div class = "explain" style="font-size: 20px">
					<p style="font-size: 30px" >해변이 파노라마처럼 펼쳐지는 스위트 룸</p>
					<p style="font-weight: bold;color: black">모노그램 스위트 룸은 호텔 본관 상층부(7~10층) 전면에 위치하여, </p>
					<p style="font-weight: bold;color: black">파노라마처럼 펼쳐진 바다를 바라볼 수 있는 객실입니다.</p>
					<br>
					<문의전화>
