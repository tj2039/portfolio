...
<article class="singleForm">
	<form name="frmGuestOut" method="post" action="guestEdit_pwdChk_ok.jsp">
		<fieldset>
			<%if(O_userid!=null&& !O_userid.isEmpty()){ %>
				<legend><%=O_userid %>님 비밀번호를 입력하세요</legend>
			<%}%>
			...
			<div style="display:tabled	; width: 400px; margin: auto;">
				<div class="btn-group" role="group">
					<button type="submit" class="btn btn-dark btn-block" style="width: 400px;">회원정보수정</button>
				</div>
			</div>
		</fieldset>
	</form>
