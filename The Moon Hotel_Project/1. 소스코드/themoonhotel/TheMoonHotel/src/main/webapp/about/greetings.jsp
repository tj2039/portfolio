	...
	<div class="container text-left">
		<div class="row">
			<div class="col col-lg-6 col-md-12 card card-body" style=" border:0px">
				...
				<h3 class="card-title">The Moon Hotel</h3>
				<br>
			...
			<div class="col col-lg-6 col-md-12 card" style="border:0px; ">
				<img src="../images/greetings1.jpg" class="card-img-top contentImg" alt="...">
			</div>
		</div>
	</div>
</article>
